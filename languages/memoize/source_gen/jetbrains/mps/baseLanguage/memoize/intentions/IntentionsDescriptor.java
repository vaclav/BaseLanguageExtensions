    ...
    switch (index) {
      case 0:
        ...
        if (myIntentions0 == null) {
          ...
          myIntentions0[0] = new MakeMethodMemoized_Intention();
          myIntentions0[1] = new MakeMethodNotMemoized_Intention();
        }
      ...
      case 1:
        ...
        if (myIntentions1 == null) {
          ...
          myIntentions1[0] = new MakeClosureMemoized_Intention();
          myIntentions1[1] = new MakeClosureNotMemoized_Intention();
        }
