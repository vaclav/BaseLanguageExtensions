...
public class Calculator {
  ...
  public static _FunctionTypes._return_P1_E0<? extends Long, ? super Integer> factorial = (memoizedCacheForClosures_4_Closure = (final Integer n) -> {
  ...
  public class NestedCalculator {
    ...
    public _FunctionTypes._return_P1_E0<? extends Long, ? super Integer> nestedInstanceFactorial = (memoizedCacheForClosures_6_Closure = (final Integer n) -> {
      final KeyCalculator key = new KeyCalculator();
      key.addKey(n);
  ...
  public static class StaticNestedCalculator {
    ...
    public static _FunctionTypes._return_P1_E0<? extends Long, ? super Integer> factorial = (memoizedCacheForClosures_7_Closure = (final Integer n) -> {
      final KeyCalculator key = new KeyCalculator();
      key.addKey(n);
    ...
    private int counter;
    public _FunctionTypes._return_P1_E0<? extends Long, ? super Integer> nestedInstanceFactorial = (memoizedCacheForClosures_8_Closure = (final Integer n) -> {
      final KeyCalculator key = new KeyCalculator();
      key.addKey(n);
